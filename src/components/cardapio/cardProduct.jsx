export default function CardProduct({ title, value, image }) {
	return (
		<div className='bg-white flex flex-col basis-24 flex-grow h-40  md:h-72 md:basis-52 p-3 rounded-3xl shadow-sm justify-between items-center hover:bg-orange-400 cursor-pointer md:flex-grow-0 '>
